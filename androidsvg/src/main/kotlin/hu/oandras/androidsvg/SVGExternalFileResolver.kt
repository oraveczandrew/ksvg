 ...
 * 
 * 
 * The default behavior of each method is to tell AndroidSVG that the reference could not be found.
 * Extend this class and override the methods if you want to customize how AndroidSVG treats font, image, and external CSS references.
 * 
 * <h3>Example usage</h3>
 * 
 * <pre class="code-block">
 * `public class MyResolver {    // Override the default method implementations with your own.    // See the code for SimpleAssetResolver class, for examples of how to do that. } // Register your resolver with AndroidSVG SVG.registerExternalFileResolver(new MyResolver()); // Your resolver will now be used when an SVG is parsed or rendered, SVG mySVG = SVG.getFromX(); `
</pre> * 
 */
public open class SVGExternalFileResolver {
    /**
