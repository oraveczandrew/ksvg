...
public open class SVGExternalFileResolver {
     ...
     * {code fontStyle} parameter to choose between those two font files, and leave KSVG to do
     * the rest.
     * 
