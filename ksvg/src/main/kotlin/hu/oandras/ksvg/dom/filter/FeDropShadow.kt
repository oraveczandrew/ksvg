...
internal class FeDropShadow(
    ...
    class Builder(
        document: SVGImpl,
        parent: Container?,
    ) : FilterPrimitive.Builder<FeDropShadow>(
        document = document,
        parent = parent
    ) {
        private var dx: CSSLength? = null
        private var dy: CSSLength? = null
        private var stdDeviationX: Float = 0f
        ...
        override fun onAttribute(
            ...
            when (attr) {
                SVGAttr.dx -> dx = parseLength(value)
        ...
        override fun build(): FeDropShadow {
            return FeDropShadow(
